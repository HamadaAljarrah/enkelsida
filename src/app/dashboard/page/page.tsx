...
import { getPageByWebsiteIdAndPageId } from '@/services/pages';
...
const page = async ({ searchParams }: Props) => {
    ...
    const page = await getPageByWebsiteIdAndPageId({ websiteId: searchParams.website as string, pageId: searchParams.page as string });
